    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-[#ffffff] to-[#f3f4f6] p-4">
      ...
      <div className="w-full max-w-6xl flex items-center justify-center gap-12">
        ...
        <div
          ...
          style={{
            backgroundImage: 'url("/src/assets/images/premium_photo-1672287579489-4e92e57de92a.jpeg")',
          }}
        />
          ...
          <div className="flex flex-col gap-6">
            ...
            <form onSubmit={handleNext} className="space-y-6">
              ...
              <div className="flex gap-3 items-center justify-center pt-4">
                <Button
                  ...
                  size="lg"
                  disabled={loading}
                  className="flex-1 bg-[#007EA7] text-white font-medium py-4 rounded-lg max-w-sm"
                >
                ...
                {step > 1 && (
                  <button
                    ...
                    className="px-8 py-4 text-[#007EA7] hover:bg-[#f0f0f0] rounded-lg transition-colors font-medium"
                  >
                    Voltar
                  </button>
                )}
            ...
            <div className="text-center">
              <button
                ...
                className="text-black hover:text-[#333333] transition-colors text-sm"
              >
