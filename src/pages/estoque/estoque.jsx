  ...
  const filteredEstoque = useMemo(() => {
    ...
    if (selectedFilterDate) {
      ...
      items = items.filter((item) => {
        ...
        return item.detalhes.movimentos.some(
          (mov) => mov.data === filterDateStr
        );
      });
    }
    ...
    <div className="flex bg-gray-50 min-h-screen">
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <main className="flex-1 p-4 md:p-8">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-gray-800 pb-4">
            Controle de estoque
          </h1>
            ...
            <div className="bg-white p-4 md:p-6 rounded-lg shadow-sm border border-gray-200">
                    ...
                    paginatedEstoque.map((item) => {
                      ...
                      const itemFormatado = {
                        ...
                        detalhes: item.detalhes
                          ? {
                              ...item.detalhes,
                              valorCompra: formatCurrency(
                                item.detalhes.valorCompra
                              ),
                              valorVenda: formatCurrency(
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-200 mt-4">
                <p className="text-sm text-gray-600">
                  ...
                  de{" "}
                  <span className="font-medium">{filteredEstoque.length}</span>{" "}
                  resultados
                </p>
