    ...
    <div>
      ...
      <div className="min-h-screen bg-[#f8fafc] flex flex-col items-center justify-center px-8 py-12 gap-10 font-[Inter]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-6xl">
          {/* Alertas de Estoque */}
          <div className="bg-white border border-gray-200 rounded-md shadow-sm overflow-hidden hover:shadow-md transition-all duration-200">
            ...
            <div className="divide-y divide-gray-100">
              {produtos.map((produto, idx) => (
                <div
                  key={idx}
                  className="flex flex-col md:flex-row items-center justify-between px-20 py-10"
                >
          ...
          <div className="bg-white border border-gray-200 rounded-md shadow-sm overflow-hidden hover:shadow-md transition-all duration-200">
            ...
            <div className="divide-y divide-gray-100">
              {agendamentos.map((ag, idx) => (
                <div
                  key={idx}
                  className="flex flex-col md:flex-row items-center justify-between px-5 py-10"
                >
                  <div className="text-center md:text-left">
                    <p className="font-semibold text-gray-800 text-base">
                      {ag.cliente}
